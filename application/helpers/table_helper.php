...
function get_supplier_data_row($supplier,$controller)
{
	...
	$table_data_row.='<td width="5%">'.anchor($controller_name."/payment/$supplier->person_id/width~$width", lang('common_pay'),array('class'=>'thickbox','title'=>lang('common_pay_title'))).'</td>';
