...
<div id="receipt_wrapper">
	...
	?>
	<tr>
	<td colspan="3" style='text-align:right;border-top:1px solid #000000;font-size:10px !important;'><?php echo lang('sales_sub_total'); ?></td>
	<td colspan="3" style='text-align:right;border-top:1px solid #000000;font-size:10px !important;'><?php echo to_currency($subtotal); ?></td>
	</tr>

	<?php foreach($taxes as $name=>$value) { ?>
		<tr>
			<td colspan="3" style='text-align:right;font-size:10px !important;'><?php echo $name; ?>:</td>
			<td colspan="3" style='text-align:right;font-size:10px !important;'><?php echo to_currency($value); ?></td>
		</tr>
	<?php }; ?>
