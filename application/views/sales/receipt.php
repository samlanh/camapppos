...
<div id="receipt_wrapper">
	...
	?>
	<tr>
	<td colspan="4" style='text-align:right;border-top:1px solid #000000;font-size:10px !important;'><?php echo lang('sales_sub_total'); ?></td>
	<td colspan="2" style='text-align:right;border-top:1px solid #000000;font-size:10px !important;'><?php echo to_currency($subtotal); ?></td>
	</tr>
