<head>
   <!-- Google Khmer web fontss -->
	...
	<link rel="stylesheet" rev="stylesheet" href="<?php echo base_url();?>css/font-icon/css/font-awesome.min.css?<?php echo APPLICATION_VERSION; ?>" />
	<?php		
...
<div id="menubar">
	<table id="menubar_container">
		<tr id="menubar_navigation">
			...
			<?php //echo $this->Appconfig->get_logo_image();?>
				<a class='companylogo' href="<?php echo site_url(); ?>"><?php echo img(
				array(
