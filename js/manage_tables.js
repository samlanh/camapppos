...
{	
	...
	$.post($('#search_form').attr('action'),{'search':$('#search').val()},function(response)
	{
...
function enable_sorting(sort_url,table_columns, per_page)
{
	//Keep track of enable_email has been called
	...
	$('#sortable_table tr th').toggle(function()
	{
		if (table_columns[$(this).parent().children().index($(this))])
		{
			do_sorting(sort_url, offset, table_columns[$(this).parent().children().index($(this))], "asc");
	...
	},function()
	{
		if (table_columns[$(this).parent().children().index($(this))])
		{
			do_sorting(sort_url, offset, table_columns[$(this).parent().children().index($(this))], "desc");
			$('#sortable_table tr th').removeClass('header headerSortUp').removeClass('header headerSortDown');
...
{
	$.post(sort_url,{ "search": $("#search").val(), "offset" : offset , "order_col" : order_col, "order_dir" : order_dir}, function(response)
	{
		$('#sortable_table tbody').html(response.manage_table);
		$('#pagination').html(response.pagination);
		//re-init elements in new table, as table tbody children were replaced
